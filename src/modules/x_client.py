...
class XClient:
    ...
    async def post_tweet(self, text, reply_to_id=None):
        """
        Publica un tweet con manejo de reintentos.
        Soporta responder a un tweet específico si se pasa reply_to_id.
        """
        if not self.user:
            await self.login()
        ...
        if reply_to_id:
            ...
            # CORRECCIÓN: Twikit 2.x usa 'reply_to' en lugar de 'reply_to_tweet_id'
